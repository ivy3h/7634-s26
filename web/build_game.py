...
function handleAccuse(target) {
  ...
  if (c.id === DATA.real_criminal_id) {
    ...
    addLog(
      "Somewhere at the edge of the room — by a window, lit gold by the gaslight — " +
      ...
      "You are already drafting your report.",
      "narration",
      "— the one who walked free —"
    );
    addLog(
      "The Hartley Affair is closed in the ledger of Scotland Yard, but not in " +
      "the city that reads about it tomorrow. Somewhere, the truth drifts up " +
      "the Thames with the morning fog — thin, persistent, and, for now, unheard.",
      "narration",
      "— coda —"
    );
